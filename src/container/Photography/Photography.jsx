      ...
      {photography.length && (
        <>
          ...
          <div className='app__photography-btns app__flex'>
                <div className='app__flex' onClick={() => handleClick(currentIndex === 0 ? photography.length - 1 : currentIndex - 1)}>
                  <HiChevronLeft />
                </div>
                <div className='app__flex' onClick={() => handleClick(currentIndex === photography.length - 1 ? 0 : currentIndex + 1)}>
                  <HiChevronRight />
                </div>
              </div>
        </>
